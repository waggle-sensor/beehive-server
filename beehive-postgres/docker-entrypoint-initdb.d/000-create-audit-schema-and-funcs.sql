--
-- This code was taken from https://wiki.postgresql.org/wiki/Audit_trigger_91plus . It creates
-- a table and provides a number of functions to track changes to other tables.
--
